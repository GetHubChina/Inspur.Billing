...
namespace DataModels
{
    ...
    {
        [Column("buyer_id"), PrimaryKey, NotNull] public long BuyerId { get; set; } // integer
    ...
    public partial class CodeTaxtype
    {
        ...
        [Column("calculation_mode"), Nullable] public char? CalculationMode { get; set; } // varchar(1)
        [Column("fixed_tax_amount"), Nullable] public char? FixedTaxAmount { get; set; } // varchar(1)
        [Column("registrant"), Nullable] public string Registrant { get; set; } // varchar(20)
        [Column("rdate"), Nullable] public DateTime? Rdate { get; set; } // date
        [Column("editor"), Nullable] public string Editor { get; set; } // varchar(20)
        [Column("edate"), Nullable] public DateTime? Edate { get; set; } // date
    ...
    {
        [Column("goods_id"), PrimaryKey, NotNull] public long GoodsId { get; set; } // integer
        ...
        [Column("tax_inclusive"), Nullable] public long? TaxInclusive { get; set; } // integer
    ...
    public partial class InvoiceTax
    {
        ...
        [Column("tax_rate"), Nullable] public object TaxRate { get; set; } // double precision
        [Column("tax_amount"), Nullable] public object TaxAmount { get; set; } // double precision
    }
    ...
    {
        [Column("taxpayer_id"), PrimaryKey, Identity] public int TaxpayerId { get; set; } // integer
        ...
        [Column("valid"), Nullable] public char? Valid { get; set; } // varchar(1)
        [Column("taxpayer_account"), Nullable] public string TaxpayerAccount { get; set; } // varchar(1)
    }
